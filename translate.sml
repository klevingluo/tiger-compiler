...
struct 
  ...
  fun eseq(stms) = 
    ...
    in
      case last of
         ...
         | _ => raise Fail "error, nonvalue in sequence"
    end
  ...
  fun allocLocal(LEV(parent, frm, frmref) : level)(esc) =
    ...
    | allocLocal(_)(_) = raise Fail "nonexaustive match"
